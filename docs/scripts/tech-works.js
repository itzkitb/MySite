    ...
    (function () {
        ...
        const consoleData = {
            lines: [
                ...
                "DSU> Error: The site is currently undergoing maintenance!",
                "siteunit.blbs exited with code 503",
                "",
                "root/safe> "
            ],
        ...
        setTimeout(() => {
            textAnimator.renderText(elements.title, "Тех. работы", elements.titleUnderline);
            textAnimator.renderText(elements.description,
                "Скоро будет готово...                  Наверное...", elements.descriptionUnderline);
        }, 2500);
    })();
}, delay);